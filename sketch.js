...
function setup() {
	...
	box1 = createSprite(width/2.60,600,20,100)
	box2 = createSprite(width/1.63,600,20,100)
	box.shapeColor=("red")
	box1.shapeColor=("red")
	box2.shapeColor=("red")

   if(packageSprite.velocityx<1){
	packageSprite.velocityx=0
   }

   if(packageSprite.velocityy<1){
